    ...
    <div className="container" style={{ padding: '80px 0' }}>
      ...
      <div className="card">
        ...
        <div style={{ display: 'flex', gap: '8px', marginTop: '8px' }}>
          <Link to="/help/selection" className="btn btn-outline">
            Просмотр элементов
          </Link>
          <Link to="/help/change-id" className="btn btn-outline">
            Изменение ID
          </Link>
        </div>
        
        <h3>📐 Создание контуров</h3>
        <p>Создаёт контуры по базовой линии с заданными параметрами. Автоматически строит боковые контуры с перпендикулярами.</p>
        <ul style={{ marginBottom: '16px', paddingLeft: '20px' }}>
          <li><strong>Создание контуров по базовой линии</strong> - для spline нужен шаг, для остальных линий - только ширина</li>
        </ul>
        <Link to="/help/contours" className="btn btn-outline" style={{ marginTop: '8px' }}>
          Подробнее
        </Link>
        ...
        <ul style={{ marginBottom: '16px', paddingLeft: '20px' }}>
          <li><strong>Создать папку/слой и перенести элементы</strong> - автоматическое создание структуры слоёв и перемещение объектов</li>
        </ul>
        <Link to="/help/layers" className="btn btn-outline" style={{ marginTop: '8px' }}>
          Подробнее
        </Link>
