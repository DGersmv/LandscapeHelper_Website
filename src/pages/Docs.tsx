  ...
  return (
    <div className="container" style={{ padding: '80px 0' }}>
      ...
      <div className="card">
        ...
        <div className="step">
          ...
          <ul style={{ paddingLeft: '20px', marginTop: '8px' }}>
            ...
            <li><strong>GDL</strong> - генерация кода</li>
          </ul>
        </div>
      ...
      <div className="card">
        ...
        <h3>📐 GDL генерация</h3>
        <p>Преобразование 2D-элементов в готовый GDL-код для создания параметрических объектов.</p>
        <ul style={{ marginBottom: '16px', paddingLeft: '20px' }}>
          <li><strong>Генерация GDL-кода</strong> - создание скриптов из линий и дуг</li>
          <li><strong>Поддержка всех элементов</strong> - линии, дуги, полилинии, сплайны, штриховки</li>
        </ul>
