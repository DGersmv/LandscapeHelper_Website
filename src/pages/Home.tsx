...
function Home() {
  const functionSections = [
      ...
      functions: [
        {
          ...
          description: 'Показывает тип, ID и количество выделенных объектов. Помогает проверить правильность выделения перед выполнением операций.',
    ...
    {
      title: 'Создание контуров',
      icon: 'vector-square',
      color: '#FF9800',
      functions: [
        {
          title: 'Создание контуров по базовой линии',
          description: 'Создаёт контуры по базовой линии с заданными параметрами. Для spline нужен шаг, для остальных линий - только ширина.',
          videoPath: '/media/Contours/Create-contours/preview.mp4',
          linkTo: '/help/contours'
        }
      ]
    },
    {
      ...
      functions: [
        {
          title: 'Создать папку/слой и перенести элементы',
          description: 'Создаёт папку/слой и переносит выделенные элементы в новый слой. Автоматически организует структуру слоёв.',
          videoPath: '/media/Layers/Create-layer-and-move-elements/preview.mp4',
          linkTo: '/help/layers'
        }
      ]
    },
