  ...
  return (
    <div>
      <h1 style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
        ...
        Изменение ID выделенных объектов
      </h1>
      ...
      <div style={{ 
        ...
        >
          <source src="/media/Selection/Change-ID/preview.mp4" type="video/mp4" />
        ...
        <div style={{ 
          ...
          <button 
            onClick={() => {
              const videoUrl = window.location.origin + '/media/Selection/Change-ID/preview.mp4';
      ...
      <h2>Описание</h2>
      <p>Мощная функция для массового переименования ID всех выделенных объектов. Позволяет организовать и систематизировать объекты в проекте с помощью осмысленных названий и автоматической нумерации.</p>
      ...
      <div className="step">
        <h4>1. Выделите объекты</h4>
        <p>Выделите объекты, которые нужно переименовать. Можно выбрать несколько объектов одновременно.</p>
      </div>
      
      <div className="step">
        <h4>2. Введите новый ID</h4>
        <p>В поле "Новый ID" введите желаемое название (например, "Сосна обыкновенная").</p>
      </div>
      
      <div className="step">
        <h4>3. Нажмите "Изменить ID"</h4>
